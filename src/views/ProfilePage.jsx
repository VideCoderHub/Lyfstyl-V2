      ...
      <PageHero
        ...
        actions={
          <>
            ...
            <Link href={`/creators/${user?.id}`} className="btn btn--outline">Public view</Link>
          </>
        }
      />
      ...
      <section className="content-wrap profile-layout">
        ...
        <aside className="profile-side">
          <div className="dash-panel">
            ...
            {pending.length ? (
              <>
                ...
                <ul className="profile-connect-list">
                  {pending.map((c) => (
                    <li key={c.id}>
                      <Link href={`/creators/${c.user.id}`}>{c.user.name}</Link>
                      <ConnectButton
                        userId={c.user.id}
            ...
            <Link href="/messages" className="btn btn--outline btn--block">Open messages</Link>
          </div>
