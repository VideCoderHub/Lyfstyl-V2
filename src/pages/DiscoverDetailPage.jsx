...
export default function DiscoverDetailPage() {
    ...
    return (
      <main className="subpage">
        <div className="content-wrap">
          ...
          <Link to="/discover" className="btn btn--outline">Back to Discover</Link>
        </div>
      </main>
    )
  }
  ...
  async function starLinked() {
    if (!linked || !isAuthenticated) return navigate('/login')
      ...
      <article className="detail">
        ...
        <div className="content-wrap detail__body">
          ...
          <div className="detail__head">
            ...
            {item.communitySlug ? (
              <Link to={`/community/${item.communitySlug}`} className="btn btn--outline">
