      ...
      <PageHero
        ...
        actions={
          <>
            ...
            <Link to="/discover" className="btn btn--outline">Explore feed</Link>
          </>
        }
      />
        ...
        <div className="dash-grid">
          <section className="dash-panel">
            <div className="section-head">
              ...
              <Link to="/community">Browse all</Link>
            </div>
              ...
              {dashboard.challenges.map((c) => (
                <article key={c.id} className={`challenge-card challenge-card--${c.tone ?? 'lime'}`}>
                  ...
                  <div className="challenge-card__actions">
                    <Link to={`/challenges/${c.id}`} className="btn btn--outline">View</Link>
